...
class CanvasDuplicateCleaner:
    ...
    def _get_page_objects(self) -> Tuple[List[Dict], List[Dict]]:
        ...
        all_pages = self._make_paginated_request(f"courses/{self.course_id}/pages")
    ...
    def analyze_duplicates(self) -> Dict:
        ...
        page_hashes: Dict[str, str] = {p['url']: self._normalize_and_hash(p.get('body')) for p in all_pages}
